    ...
    <BoxWrapper>
        ...
        <Paragraph>
            <Box mb={5}>
                ...
                in the field of <DynamicText typeSpeed={0} text={['3D graphics (3ds MAX)']} /> and Unreal Engine with C++ basics.
            </Box>

            <Box mb={5}>
                After 2 years in this domain, I decided to dig deeper into programming, and found that creating products is
                my passion. I worked as a <DynamicText typeSpeed={0} text={['Full-stack developer']} /> (C#, SQL, React/Angular.js) and have completed the migration
            ...
            <Box mb={5}>
                On a volunteer basis, I gathered and taught a group of <DynamicText typeSpeed={0} text={['15 beginner programmers.']} />
